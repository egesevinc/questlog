...
import { getMyLogs, deleteLog, type GameLog } from '../api/logs'
          ...
          {logs.map((log) => (
            <div key={log.id} className="group relative">
              ...
              <button
                ...
                className="absolute top-1 right-1 bg-base/80 text-text-muted hover:text-red-400 text-xs rounded px-1.5 py-0.5 cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity"
              >
                Delete
              </button>
            </div>
